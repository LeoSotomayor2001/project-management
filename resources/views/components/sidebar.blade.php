<div class="h-screen flex flex-col">
    ...
    <nav class="mt-5 flex-1 overflow-y-auto">
        <ul>
            ...
            <li class="mb-2">
                <a href="{{ route('proyectos.index') }}" class="block py-2.5 px-4 rounded transition duration-200 hover:bg-indigo-700 {{ Route::currentRouteName() == 'proyectos.index' ? 'bg-indigo-700 text-white' : '' }}">
                    Proyectos
                </a>
            </li>
            <li class="mb-2">
